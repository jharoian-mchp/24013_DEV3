...
#ifndef _PIC32CZCA90_GCLK_COMPONENT_H_
#define _PIC32CZCA90_GCLK_COMPONENT_H_
...
#define GCLK_SYNCBUSY_GENCTRL9(value)         (GCLK_SYNCBUSY_GENCTRL9_Msk & (_UINT32_(value) << GCLK_SYNCBUSY_GENCTRL9_Pos)) /* Assigment of value for GENCTRL9 in the GCLK_SYNCBUSY register */
...
#define GCLK_SYNCBUSY_GENCTRL10(value)        (GCLK_SYNCBUSY_GENCTRL10_Msk & (_UINT32_(value) << GCLK_SYNCBUSY_GENCTRL10_Pos)) /* Assigment of value for GENCTRL10 in the GCLK_SYNCBUSY register */
...
#define GCLK_SYNCBUSY_GENCTRL11(value)        (GCLK_SYNCBUSY_GENCTRL11_Msk & (_UINT32_(value) << GCLK_SYNCBUSY_GENCTRL11_Pos)) /* Assigment of value for GENCTRL11 in the GCLK_SYNCBUSY register */
#define GCLK_SYNCBUSY_GENCTRL12_Pos           _UINT32_(14)                                         /* (GCLK_SYNCBUSY) Generic Clock Generator Control 12 Synchronization Busy bit Position */
#define GCLK_SYNCBUSY_GENCTRL12_Msk           (_UINT32_(0x1) << GCLK_SYNCBUSY_GENCTRL12_Pos)       /* (GCLK_SYNCBUSY) Generic Clock Generator Control 12 Synchronization Busy bit Mask */
#define GCLK_SYNCBUSY_GENCTRL12(value)        (GCLK_SYNCBUSY_GENCTRL12_Msk & (_UINT32_(value) << GCLK_SYNCBUSY_GENCTRL12_Pos)) /* Assigment of value for GENCTRL12 in the GCLK_SYNCBUSY register */
#define GCLK_SYNCBUSY_GENCTRL13_Pos           _UINT32_(15)                                         /* (GCLK_SYNCBUSY) Generic Clock Generator Control 13 Synchronization Busy bit Position */
#define GCLK_SYNCBUSY_GENCTRL13_Msk           (_UINT32_(0x1) << GCLK_SYNCBUSY_GENCTRL13_Pos)       /* (GCLK_SYNCBUSY) Generic Clock Generator Control 13 Synchronization Busy bit Mask */
#define GCLK_SYNCBUSY_GENCTRL13(value)        (GCLK_SYNCBUSY_GENCTRL13_Msk & (_UINT32_(value) << GCLK_SYNCBUSY_GENCTRL13_Pos)) /* Assigment of value for GENCTRL13 in the GCLK_SYNCBUSY register */
#define GCLK_SYNCBUSY_GENCTRL14_Pos           _UINT32_(16)                                         /* (GCLK_SYNCBUSY) Generic Clock Generator Control 14 Synchronization Busy bit Position */
#define GCLK_SYNCBUSY_GENCTRL14_Msk           (_UINT32_(0x1) << GCLK_SYNCBUSY_GENCTRL14_Pos)       /* (GCLK_SYNCBUSY) Generic Clock Generator Control 14 Synchronization Busy bit Mask */
#define GCLK_SYNCBUSY_GENCTRL14(value)        (GCLK_SYNCBUSY_GENCTRL14_Msk & (_UINT32_(value) << GCLK_SYNCBUSY_GENCTRL14_Pos)) /* Assigment of value for GENCTRL14 in the GCLK_SYNCBUSY register */
#define GCLK_SYNCBUSY_GENCTRL15_Pos           _UINT32_(17)                                         /* (GCLK_SYNCBUSY) Generic Clock Generator Control 15 Synchronization Busy bit Position */
#define GCLK_SYNCBUSY_GENCTRL15_Msk           (_UINT32_(0x1) << GCLK_SYNCBUSY_GENCTRL15_Pos)       /* (GCLK_SYNCBUSY) Generic Clock Generator Control 15 Synchronization Busy bit Mask */
#define GCLK_SYNCBUSY_GENCTRL15(value)        (GCLK_SYNCBUSY_GENCTRL15_Msk & (_UINT32_(value) << GCLK_SYNCBUSY_GENCTRL15_Pos)) /* Assigment of value for GENCTRL15 in the GCLK_SYNCBUSY register */
#define GCLK_SYNCBUSY_Msk                     _UINT32_(0x0003FFFD)                                 /* (GCLK_SYNCBUSY) Register Mask  */

#define GCLK_SYNCBUSY_GENCTRL_Pos             _UINT32_(2)                                          /* (GCLK_SYNCBUSY Position) Generic Clock Generator Control x5 Synchronization Busy bit */
#define GCLK_SYNCBUSY_GENCTRL_Msk             (_UINT32_(0xFFFF) << GCLK_SYNCBUSY_GENCTRL_Pos)      /* (GCLK_SYNCBUSY Mask) GENCTRL */
...
#define   GCLK_GENCTRL_SRC_XOSC_Val           _UINT32_(0x0)                                        /* (GCLK_GENCTRL) XOSC0 oscillator output  */
...
#define   GCLK_GENCTRL_SRC_DFLL_Val           _UINT32_(0x5)                                        /* (GCLK_GENCTRL) DFLL output  */
#define   GCLK_GENCTRL_SRC_PLL0_1_Val         _UINT32_(0x6)                                        /* (GCLK_GENCTRL) PLL0 output 1  */
#define   GCLK_GENCTRL_SRC_PLL0_2_Val         _UINT32_(0x7)                                        /* (GCLK_GENCTRL) PLL0 output 2  */
#define   GCLK_GENCTRL_SRC_PLL0_3_Val         _UINT32_(0x8)                                        /* (GCLK_GENCTRL) PLL0 output 3  */
#define   GCLK_GENCTRL_SRC_PLL0_4_Val         _UINT32_(0x9)                                        /* (GCLK_GENCTRL) PLL0 output 4  */
#define   GCLK_GENCTRL_SRC_PLL1_1_Val         _UINT32_(0xA)                                        /* (GCLK_GENCTRL) Frac Divider PLL1 output 1  */
#define   GCLK_GENCTRL_SRC_PLL1_2_Val         _UINT32_(0xB)                                        /* (GCLK_GENCTRL) Frac Divider PLL1 output 2  */
#define   GCLK_GENCTRL_SRC_PLL1_3_Val         _UINT32_(0xC)                                        /* (GCLK_GENCTRL) PLL1 output 3  */
#define   GCLK_GENCTRL_SRC_PLL1_4_Val         _UINT32_(0xD)                                        /* (GCLK_GENCTRL) PLL1 output 4  */
#define GCLK_GENCTRL_SRC_XOSC                 (GCLK_GENCTRL_SRC_XOSC_Val << GCLK_GENCTRL_SRC_Pos)  /* (GCLK_GENCTRL) XOSC0 oscillator output Position  */
...
#define GCLK_GENCTRL_SRC_PLL0_1               (GCLK_GENCTRL_SRC_PLL0_1_Val << GCLK_GENCTRL_SRC_Pos) /* (GCLK_GENCTRL) PLL0 output 1 Position  */
#define GCLK_GENCTRL_SRC_PLL0_2               (GCLK_GENCTRL_SRC_PLL0_2_Val << GCLK_GENCTRL_SRC_Pos) /* (GCLK_GENCTRL) PLL0 output 2 Position  */
#define GCLK_GENCTRL_SRC_PLL0_3               (GCLK_GENCTRL_SRC_PLL0_3_Val << GCLK_GENCTRL_SRC_Pos) /* (GCLK_GENCTRL) PLL0 output 3 Position  */
#define GCLK_GENCTRL_SRC_PLL0_4               (GCLK_GENCTRL_SRC_PLL0_4_Val << GCLK_GENCTRL_SRC_Pos) /* (GCLK_GENCTRL) PLL0 output 4 Position  */
#define GCLK_GENCTRL_SRC_PLL1_1               (GCLK_GENCTRL_SRC_PLL1_1_Val << GCLK_GENCTRL_SRC_Pos) /* (GCLK_GENCTRL) Frac Divider PLL1 output 1 Position  */
#define GCLK_GENCTRL_SRC_PLL1_2               (GCLK_GENCTRL_SRC_PLL1_2_Val << GCLK_GENCTRL_SRC_Pos) /* (GCLK_GENCTRL) Frac Divider PLL1 output 2 Position  */
#define GCLK_GENCTRL_SRC_PLL1_3               (GCLK_GENCTRL_SRC_PLL1_3_Val << GCLK_GENCTRL_SRC_Pos) /* (GCLK_GENCTRL) PLL1 output 3 Position  */
#define GCLK_GENCTRL_SRC_PLL1_4               (GCLK_GENCTRL_SRC_PLL1_4_Val << GCLK_GENCTRL_SRC_Pos) /* (GCLK_GENCTRL) PLL1 output 4 Position  */
...
#define   GCLK_PCHCTRL_GEN_GCLK12_Val         _UINT32_(0xC)                                        /* (GCLK_PCHCTRL) Generic clock generator 12  */
#define   GCLK_PCHCTRL_GEN_GCLK13_Val         _UINT32_(0xD)                                        /* (GCLK_PCHCTRL) Generic clock generator 13  */
#define   GCLK_PCHCTRL_GEN_GCLK14_Val         _UINT32_(0xE)                                        /* (GCLK_PCHCTRL) Generic clock generator 14  */
#define   GCLK_PCHCTRL_GEN_GCLK15_Val         _UINT32_(0xF)                                        /* (GCLK_PCHCTRL) Generic clock generator 15  */
...
#define GCLK_PCHCTRL_GEN_GCLK12               (GCLK_PCHCTRL_GEN_GCLK12_Val << GCLK_PCHCTRL_GEN_Pos) /* (GCLK_PCHCTRL) Generic clock generator 12 Position  */
#define GCLK_PCHCTRL_GEN_GCLK13               (GCLK_PCHCTRL_GEN_GCLK13_Val << GCLK_PCHCTRL_GEN_Pos) /* (GCLK_PCHCTRL) Generic clock generator 13 Position  */
#define GCLK_PCHCTRL_GEN_GCLK14               (GCLK_PCHCTRL_GEN_GCLK14_Val << GCLK_PCHCTRL_GEN_Pos) /* (GCLK_PCHCTRL) Generic clock generator 14 Position  */
#define GCLK_PCHCTRL_GEN_GCLK15               (GCLK_PCHCTRL_GEN_GCLK15_Val << GCLK_PCHCTRL_GEN_Pos) /* (GCLK_PCHCTRL) Generic clock generator 15 Position  */
...
#define GCLK_GENCTRL12_REG_OFST        _UINT32_(0x50)      /* (GCLK_GENCTRL12) Generic Clock Generator Control Offset */
#define GCLK_GENCTRL13_REG_OFST        _UINT32_(0x54)      /* (GCLK_GENCTRL13) Generic Clock Generator Control Offset */
#define GCLK_GENCTRL14_REG_OFST        _UINT32_(0x58)      /* (GCLK_GENCTRL14) Generic Clock Generator Control Offset */
#define GCLK_GENCTRL15_REG_OFST        _UINT32_(0x5C)      /* (GCLK_GENCTRL15) Generic Clock Generator Control Offset */
...
#define GCLK_PCHCTRL48_REG_OFST        _UINT32_(0x140)     /* (GCLK_PCHCTRL48) Peripheral Clock Control Offset */
#define GCLK_PCHCTRL49_REG_OFST        _UINT32_(0x144)     /* (GCLK_PCHCTRL49) Peripheral Clock Control Offset */
#define GCLK_PCHCTRL50_REG_OFST        _UINT32_(0x148)     /* (GCLK_PCHCTRL50) Peripheral Clock Control Offset */
#define GCLK_PCHCTRL51_REG_OFST        _UINT32_(0x14C)     /* (GCLK_PCHCTRL51) Peripheral Clock Control Offset */
#define GCLK_PCHCTRL52_REG_OFST        _UINT32_(0x150)     /* (GCLK_PCHCTRL52) Peripheral Clock Control Offset */
#define GCLK_PCHCTRL53_REG_OFST        _UINT32_(0x154)     /* (GCLK_PCHCTRL53) Peripheral Clock Control Offset */
#define GCLK_PCHCTRL54_REG_OFST        _UINT32_(0x158)     /* (GCLK_PCHCTRL54) Peripheral Clock Control Offset */
#define GCLK_PCHCTRL55_REG_OFST        _UINT32_(0x15C)     /* (GCLK_PCHCTRL55) Peripheral Clock Control Offset */
#define GCLK_PCHCTRL56_REG_OFST        _UINT32_(0x160)     /* (GCLK_PCHCTRL56) Peripheral Clock Control Offset */
#define GCLK_PCHCTRL57_REG_OFST        _UINT32_(0x164)     /* (GCLK_PCHCTRL57) Peripheral Clock Control Offset */
#define GCLK_PCHCTRL58_REG_OFST        _UINT32_(0x168)     /* (GCLK_PCHCTRL58) Peripheral Clock Control Offset */
#define GCLK_PCHCTRL59_REG_OFST        _UINT32_(0x16C)     /* (GCLK_PCHCTRL59) Peripheral Clock Control Offset */
#define GCLK_PCHCTRL60_REG_OFST        _UINT32_(0x170)     /* (GCLK_PCHCTRL60) Peripheral Clock Control Offset */
#define GCLK_PCHCTRL61_REG_OFST        _UINT32_(0x174)     /* (GCLK_PCHCTRL61) Peripheral Clock Control Offset */
#define GCLK_PCHCTRL62_REG_OFST        _UINT32_(0x178)     /* (GCLK_PCHCTRL62) Peripheral Clock Control Offset */
#define GCLK_PCHCTRL63_REG_OFST        _UINT32_(0x17C)     /* (GCLK_PCHCTRL63) Peripheral Clock Control Offset */
...
{  /* Generic Clock Generator */
  ...
  __IO  uint32_t                       GCLK_GENCTRL[16];   /**< Offset: 0x20 (R/W  32) Generic Clock Generator Control */
  __I   uint8_t                        Reserved3[0x20];
  __IO  uint32_t                       GCLK_PCHCTRL[64];   /**< Offset: 0x80 (R/W  32) Peripheral Clock Control */
} gclk_registers_t;


#endif /* !(defined(__ASSEMBLER__) || defined(__IAR_SYSTEMS_ASM__)) */
#endif /* _PIC32CZCA90_GCLK_COMPONENT_H_ */
