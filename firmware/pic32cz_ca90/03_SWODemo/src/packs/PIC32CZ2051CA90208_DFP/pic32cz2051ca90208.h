/*
 * Header file for PIC32CZ2051CA90208
 *
...
/* File generated from device description file (ATDF) version 2024-07-31T17:50:31Z */
#ifndef _PIC32CZ2051CA90208_H_
#define _PIC32CZ2051CA90208_H_
...
/* PIC32CZ2051CA90208 definitions
  This file defines all structures and symbols for PIC32CZ2051CA90208:
...
/* ************************************************************************** */
/* CMSIS DEFINITIONS FOR PIC32CZ2051CA90208                                 */
/* ************************************************************************** */
#if !(defined(__ASSEMBLER__) || defined(__IAR_SYSTEMS_ASM__))
...
/******  PIC32CZ2051CA90208 specific Interrupt Numbers ***********************************/
  ...
  HSM_TAMPER_IRQn           = 215, /* 215 Hardware Security Module (HSM)      */
  HSM_TXINT_IRQn            = 216, /* 216 Hardware Security Module (HSM)      */
  HSM_RXINT_IRQn            = 217, /* 217 Hardware Security Module (HSM)      */
...
typedef struct _DeviceVectors
{
  ...
  void* pfnHSM_TAMPER_Handler;                   /* 215 Hardware Security Module (HSM) */
  void* pfnHSM_TXINT_Handler;                    /* 216 Hardware Security Module (HSM) */
  void* pfnHSM_RXINT_Handler;                    /* 217 Hardware Security Module (HSM) */
...
#include "system_pic32czca90.h"
#endif /* USE_CMSIS_INIT */

/* ************************************************************************** */
/*   SOFTWARE PERIPHERAL API DEFINITION FOR PIC32CZ2051CA90208                */
/* ************************************************************************** */
...
/* ************************************************************************** */
/*   INSTANCE DEFINITIONS FOR PIC32CZ2051CA90208 */
/* ************************************************************************** */
...
/* ************************************************************************** */
/*  PERIPHERAL ID DEFINITIONS FOR PIC32CZ2051CA90208                          */
/* ************************************************************************** */
...
/* ************************************************************************** */
/*   REGISTER STRUCTURE ADDRESS DEFINITIONS FOR PIC32CZ2051CA90208            */
/* ************************************************************************** */
#if !(defined(__ASSEMBLER__) || defined(__IAR_SYSTEMS_ASM__))
...
#define HSM_REGS                         ((hsm_registers_t*)0x4f018000)                /* HSM Registers Address        */
...
/* ************************************************************************** */
/*   BASE ADDRESS DEFINITIONS FOR PIC32CZ2051CA90208                          */
/* ************************************************************************** */
...
#define HSM_BASE_ADDRESS                 _UINT32_(0x4f018000)                          /* HSM Base Address */
...
/* ************************************************************************** */
/*   PIO DEFINITIONS FOR PIC32CZ2051CA90208                                   */
/* ************************************************************************** */
#include "pio/pic32cz2051ca90208.h"

/* ************************************************************************** */
/*   MEMORY MAPPING DEFINITIONS FOR PIC32CZ2051CA90208                        */
/* ************************************************************************** */
...
#define FCR_CFM_HSMCFG0_SIZE           _UINT32_(0x00001000)    /*    4kB Memory segment type: flash */
#define FCR_CFM_HSMCFG0_PAGE_SIZE      _UINT32_(      4096)
#define FCR_CFM_HSMCFG0_NB_OF_PAGES    _UINT32_(         1)

#define FCR_CFM_HSMCFG1_SIZE           _UINT32_(0x00001000)    /*    4kB Memory segment type: flash */
#define FCR_CFM_HSMCFG1_PAGE_SIZE      _UINT32_(      4096)
#define FCR_CFM_HSMCFG1_NB_OF_PAGES    _UINT32_(         1)

#define FCR_CFM_HSMCFG2_SIZE           _UINT32_(0x00001000)    /*    4kB Memory segment type: flash */
#define FCR_CFM_HSMCFG2_PAGE_SIZE      _UINT32_(      4096)
#define FCR_CFM_HSMCFG2_NB_OF_PAGES    _UINT32_(         1)

#define FCR_CFM_HSMCFG3_SIZE           _UINT32_(0x00001000)    /*    4kB Memory segment type: flash */
#define FCR_CFM_HSMCFG3_PAGE_SIZE      _UINT32_(      4096)
#define FCR_CFM_HSMCFG3_NB_OF_PAGES    _UINT32_(         1)
...
#define FLEXRAM_SIZE                   _UINT32_(0x00080000)    /*  512kB Memory segment type: ram */
...
#define FCR_CFM_HSMCFG0_ADDR           _UINT32_(0x0a00c000)    /* FCR_CFM_HSMCFG0 base address (type: flash)*/
#define FCR_CFM_HSMCFG1_ADDR           _UINT32_(0x0a00d000)    /* FCR_CFM_HSMCFG1 base address (type: flash)*/
#define FCR_CFM_HSMCFG2_ADDR           _UINT32_(0x0a00e000)    /* FCR_CFM_HSMCFG2 base address (type: flash)*/
#define FCR_CFM_HSMCFG3_ADDR           _UINT32_(0x0a00f000)    /* FCR_CFM_HSMCFG3 base address (type: flash)*/
...
/* ************************************************************************** */
/*   DEVICE SIGNATURES FOR PIC32CZ2051CA90208                                 */
/* ************************************************************************** */
#define CHIP_DSU_DID                   _UINT32_(0X0920E053)

/* ************************************************************************** */
/*   ELECTRICAL DEFINITIONS FOR PIC32CZ2051CA90208                            */
/* ************************************************************************** */

/* ************************************************************************** */
/* Event Generator IDs for C32CZ2051CA90208 */
/* ************************************************************************** */
...
/* ************************************************************************** */
/*  Event User IDs for C32CZ2051CA90208 */
/* ************************************************************************** */
