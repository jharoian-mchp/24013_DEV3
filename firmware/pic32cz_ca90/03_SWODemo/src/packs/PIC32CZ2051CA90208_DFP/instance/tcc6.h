...
#ifndef _PIC32CZCA90_TCC6_INSTANCE_
#define _PIC32CZCA90_TCC6_INSTANCE_


/* ========== Instance Parameter definitions for TCC6 peripheral ========== */
#define TCC6_CC_NUM                              (2)        /* Number of Compare/Capture units */
#define TCC6_DITHERING                           (1)        /* Dithering feature implemented */
#define TCC6_DMAC_ID_MC_0                        (60)       /* Indexes of DMA Match/Compare triggers 0 */
#define TCC6_DMAC_ID_MC_1                        (61)       /* Indexes of DMA Match/Compare triggers 1 */
...
#endif /* _PIC32CZCA90_TCC6_INSTANCE_ */
