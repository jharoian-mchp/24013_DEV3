...
#define DSU_BMX_ERROR_SUPPORT                    (1)        /* Defines whether DSU APB errors are reported as 2-cycles bus errors to the AHB AP0 master */
#define DSU_DAL1_IMPLEMENTED                     (0)        /* Debug Access Level 1 (Non-Secure) Implemented? for TZ devices only */
...
#define DSU_MCLK_ID_APB                          (1)        /* Index for DSU APB clock */
#define DSU_PAC_ID                               (0)        /* Index for DSU registers write protection */

#endif /* _PIC32CZCA90_DSU_INSTANCE_ */
