...
#ifndef _PIC32CZCA90_PM_COMPONENT_H_
#define _PIC32CZCA90_PM_COMPONENT_H_
...
#define PM_STDBYCFG_LPRAM(value)              (PM_STDBYCFG_LPRAM_Msk & (_UINT8_(value) << PM_STDBYCFG_LPRAM_Pos)) /* Assigment of value for LPRAM in the PM_STDBYCFG register */
...
#endif /* _PIC32CZCA90_PM_COMPONENT_H_ */
