...
#ifndef _PIC32CZCA90_SERCOM_COMPONENT_H_
#define _PIC32CZCA90_SERCOM_COMPONENT_H_
...
#define SERCOM_I2CM_CTRLA_FILTSEL(value)      (SERCOM_I2CM_CTRLA_FILTSEL_Msk & (_UINT32_(value) << SERCOM_I2CM_CTRLA_FILTSEL_Pos)) /* Assigment of value for FILTSEL in the SERCOM_I2CM_CTRLA register */
...
#define SERCOM_I2CM_CTRLA_SLEWRATE(value)     (SERCOM_I2CM_CTRLA_SLEWRATE_Msk & (_UINT32_(value) << SERCOM_I2CM_CTRLA_SLEWRATE_Pos)) /* Assigment of value for SLEWRATE in the SERCOM_I2CM_CTRLA register */
...
#define SERCOM_I2CM_CTRLA_SMBUSEN(value)      (SERCOM_I2CM_CTRLA_SMBUSEN_Msk & (_UINT32_(value) << SERCOM_I2CM_CTRLA_SMBUSEN_Pos)) /* Assigment of value for SMBUSEN in the SERCOM_I2CM_CTRLA register */
...
#define SERCOM_I2CS_CTRLA_FILTSEL(value)      (SERCOM_I2CS_CTRLA_FILTSEL_Msk & (_UINT32_(value) << SERCOM_I2CS_CTRLA_FILTSEL_Pos)) /* Assigment of value for FILTSEL in the SERCOM_I2CS_CTRLA register */
...
#define SERCOM_I2CS_CTRLA_SLEWRATE(value)     (SERCOM_I2CS_CTRLA_SLEWRATE_Msk & (_UINT32_(value) << SERCOM_I2CS_CTRLA_SLEWRATE_Pos)) /* Assigment of value for SLEWRATE in the SERCOM_I2CS_CTRLA register */
...
#define SERCOM_I2CS_CTRLA_SMBUSEN(value)      (SERCOM_I2CS_CTRLA_SMBUSEN_Msk & (_UINT32_(value) << SERCOM_I2CS_CTRLA_SMBUSEN_Pos)) /* Assigment of value for SMBUSEN in the SERCOM_I2CS_CTRLA register */
...
#define SERCOM_SPIM_CTRLC_FSES(value)         (SERCOM_SPIM_CTRLC_FSES_Msk & (_UINT32_(value) << SERCOM_SPIM_CTRLC_FSES_Pos)) /* Assigment of value for FSES in the SERCOM_SPIM_CTRLC register */
...
#define SERCOM_SPIM_CTRLC_FSLEN(value)        (SERCOM_SPIM_CTRLC_FSLEN_Msk & (_UINT32_(value) << SERCOM_SPIM_CTRLC_FSLEN_Pos)) /* Assigment of value for FSLEN in the SERCOM_SPIM_CTRLC register */
...
#define SERCOM_SPIM_CTRLC_FSPOL(value)        (SERCOM_SPIM_CTRLC_FSPOL_Msk & (_UINT32_(value) << SERCOM_SPIM_CTRLC_FSPOL_Pos)) /* Assigment of value for FSPOL in the SERCOM_SPIM_CTRLC register */
...
#define SERCOM_SPIM_CTRLC_IGNTUR(value)       (SERCOM_SPIM_CTRLC_IGNTUR_Msk & (_UINT32_(value) << SERCOM_SPIM_CTRLC_IGNTUR_Pos)) /* Assigment of value for IGNTUR in the SERCOM_SPIM_CTRLC register */
...
#define SERCOM_SPIM_CTRLC_FRMEN(value)        (SERCOM_SPIM_CTRLC_FRMEN_Msk & (_UINT32_(value) << SERCOM_SPIM_CTRLC_FRMEN_Pos)) /* Assigment of value for FRMEN in the SERCOM_SPIM_CTRLC register */
...
#define SERCOM_SPIM_CTRLC_FMODE(value)        (SERCOM_SPIM_CTRLC_FMODE_Msk & (_UINT32_(value) << SERCOM_SPIM_CTRLC_FMODE_Pos)) /* Assigment of value for FMODE in the SERCOM_SPIM_CTRLC register */
...
#define SERCOM_SPIS_CTRLC_FSES(value)         (SERCOM_SPIS_CTRLC_FSES_Msk & (_UINT32_(value) << SERCOM_SPIS_CTRLC_FSES_Pos)) /* Assigment of value for FSES in the SERCOM_SPIS_CTRLC register */
...
#define SERCOM_SPIS_CTRLC_FSLEN(value)        (SERCOM_SPIS_CTRLC_FSLEN_Msk & (_UINT32_(value) << SERCOM_SPIS_CTRLC_FSLEN_Pos)) /* Assigment of value for FSLEN in the SERCOM_SPIS_CTRLC register */
...
#define SERCOM_SPIS_CTRLC_FSPOL(value)        (SERCOM_SPIS_CTRLC_FSPOL_Msk & (_UINT32_(value) << SERCOM_SPIS_CTRLC_FSPOL_Pos)) /* Assigment of value for FSPOL in the SERCOM_SPIS_CTRLC register */
...
#define SERCOM_SPIS_CTRLC_IGNTUR(value)       (SERCOM_SPIS_CTRLC_IGNTUR_Msk & (_UINT32_(value) << SERCOM_SPIS_CTRLC_IGNTUR_Pos)) /* Assigment of value for IGNTUR in the SERCOM_SPIS_CTRLC register */
...
#define SERCOM_SPIS_CTRLC_FRMEN(value)        (SERCOM_SPIS_CTRLC_FRMEN_Msk & (_UINT32_(value) << SERCOM_SPIS_CTRLC_FRMEN_Pos)) /* Assigment of value for FRMEN in the SERCOM_SPIS_CTRLC register */
...
#define SERCOM_SPIS_CTRLC_FMODE(value)        (SERCOM_SPIS_CTRLC_FMODE_Msk & (_UINT32_(value) << SERCOM_SPIS_CTRLC_FMODE_Pos)) /* Assigment of value for FMODE in the SERCOM_SPIS_CTRLC register */
...
#define SERCOM_SPIM_STATUS_TUR(value)         (SERCOM_SPIM_STATUS_TUR_Msk & (_UINT16_(value) << SERCOM_SPIM_STATUS_TUR_Pos)) /* Assigment of value for TUR in the SERCOM_SPIM_STATUS register */
...
#define SERCOM_SPIS_STATUS_TUR(value)         (SERCOM_SPIS_STATUS_TUR_Msk & (_UINT16_(value) << SERCOM_SPIS_STATUS_TUR_Pos)) /* Assigment of value for TUR in the SERCOM_SPIS_STATUS register */
...
#endif /* _PIC32CZCA90_SERCOM_COMPONENT_H_ */
