...
#define TCC_CTRLA_FCYCLE_Pos                  _UINT32_(16)                                         /* (TCC_CTRLA) Full Cycle Position */
#define TCC_CTRLA_FCYCLE_Msk                  (_UINT32_(0x1) << TCC_CTRLA_FCYCLE_Pos)              /* (TCC_CTRLA) Full Cycle Mask */
...
#define TCC_CTRLA_CPTEN6_Pos                  _UINT32_(30)                                         /* (TCC_CTRLA) Capture Channel 6 Enable Position */
#define TCC_CTRLA_CPTEN6_Msk                  (_UINT32_(0x1) << TCC_CTRLA_CPTEN6_Pos)              /* (TCC_CTRLA) Capture Channel 6 Enable Mask */
#define TCC_CTRLA_CPTEN6(value)               (TCC_CTRLA_CPTEN6_Msk & (_UINT32_(value) << TCC_CTRLA_CPTEN6_Pos)) /* Assigment of value for CPTEN6 in the TCC_CTRLA register */
#define TCC_CTRLA_CPTEN7_Pos                  _UINT32_(31)                                         /* (TCC_CTRLA) Capture Channel 7 Enable Position */
#define TCC_CTRLA_CPTEN7_Msk                  (_UINT32_(0x1) << TCC_CTRLA_CPTEN7_Pos)              /* (TCC_CTRLA) Capture Channel 7 Enable Mask */
#define TCC_CTRLA_CPTEN7(value)               (TCC_CTRLA_CPTEN7_Msk & (_UINT32_(value) << TCC_CTRLA_CPTEN7_Pos)) /* Assigment of value for CPTEN7 in the TCC_CTRLA register */
#define TCC_CTRLA_Msk                         _UINT32_(0xFF81FF63)                                 /* (TCC_CTRLA) Register Mask  */

#define TCC_CTRLA_CPTEN_Pos                   _UINT32_(24)                                         /* (TCC_CTRLA Position) Capture Channel 7 Enable */
#define TCC_CTRLA_CPTEN_Msk                   (_UINT32_(0xFF) << TCC_CTRLA_CPTEN_Pos)              /* (TCC_CTRLA Mask) CPTEN */
...
#define TCC_SYNCBUSY_CC6_Pos                  _UINT32_(14)                                         /* (TCC_SYNCBUSY) Compare Channel 6 Busy Position */
#define TCC_SYNCBUSY_CC6_Msk                  (_UINT32_(0x1) << TCC_SYNCBUSY_CC6_Pos)              /* (TCC_SYNCBUSY) Compare Channel 6 Busy Mask */
#define TCC_SYNCBUSY_CC6(value)               (TCC_SYNCBUSY_CC6_Msk & (_UINT32_(value) << TCC_SYNCBUSY_CC6_Pos)) /* Assigment of value for CC6 in the TCC_SYNCBUSY register */
#define TCC_SYNCBUSY_CC7_Pos                  _UINT32_(15)                                         /* (TCC_SYNCBUSY) Compare Channel 7 Busy Position */
#define TCC_SYNCBUSY_CC7_Msk                  (_UINT32_(0x1) << TCC_SYNCBUSY_CC7_Pos)              /* (TCC_SYNCBUSY) Compare Channel 7 Busy Mask */
#define TCC_SYNCBUSY_CC7(value)               (TCC_SYNCBUSY_CC7_Msk & (_UINT32_(value) << TCC_SYNCBUSY_CC7_Pos)) /* Assigment of value for CC7 in the TCC_SYNCBUSY register */
#define TCC_SYNCBUSY_Msk                      _UINT32_(0x0000FFFF)                                 /* (TCC_SYNCBUSY) Register Mask  */

#define TCC_SYNCBUSY_CC_Pos                   _UINT32_(8)                                          /* (TCC_SYNCBUSY Position) Compare Channel 7 Busy */
#define TCC_SYNCBUSY_CC_Msk                   (_UINT32_(0xFF) << TCC_SYNCBUSY_CC_Pos)              /* (TCC_SYNCBUSY Mask) CC */
...
#define TCC_EVCTRL_MCEI6_Pos                  _UINT32_(22)                                         /* (TCC_EVCTRL) Match or Capture Channel 6 Event Input Enable Position */
#define TCC_EVCTRL_MCEI6_Msk                  (_UINT32_(0x1) << TCC_EVCTRL_MCEI6_Pos)              /* (TCC_EVCTRL) Match or Capture Channel 6 Event Input Enable Mask */
#define TCC_EVCTRL_MCEI6(value)               (TCC_EVCTRL_MCEI6_Msk & (_UINT32_(value) << TCC_EVCTRL_MCEI6_Pos)) /* Assigment of value for MCEI6 in the TCC_EVCTRL register */
#define TCC_EVCTRL_MCEI7_Pos                  _UINT32_(23)                                         /* (TCC_EVCTRL) Match or Capture Channel 7 Event Input Enable Position */
#define TCC_EVCTRL_MCEI7_Msk                  (_UINT32_(0x1) << TCC_EVCTRL_MCEI7_Pos)              /* (TCC_EVCTRL) Match or Capture Channel 7 Event Input Enable Mask */
#define TCC_EVCTRL_MCEI7(value)               (TCC_EVCTRL_MCEI7_Msk & (_UINT32_(value) << TCC_EVCTRL_MCEI7_Pos)) /* Assigment of value for MCEI7 in the TCC_EVCTRL register */
...
#define TCC_EVCTRL_MCEO6_Pos                  _UINT32_(30)                                         /* (TCC_EVCTRL) Match or Capture Channel 6 Event Output Enable Position */
#define TCC_EVCTRL_MCEO6_Msk                  (_UINT32_(0x1) << TCC_EVCTRL_MCEO6_Pos)              /* (TCC_EVCTRL) Match or Capture Channel 6 Event Output Enable Mask */
#define TCC_EVCTRL_MCEO6(value)               (TCC_EVCTRL_MCEO6_Msk & (_UINT32_(value) << TCC_EVCTRL_MCEO6_Pos)) /* Assigment of value for MCEO6 in the TCC_EVCTRL register */
#define TCC_EVCTRL_MCEO7_Pos                  _UINT32_(31)                                         /* (TCC_EVCTRL) Match or Capture Channel 7 Event Output Enable Position */
#define TCC_EVCTRL_MCEO7_Msk                  (_UINT32_(0x1) << TCC_EVCTRL_MCEO7_Pos)              /* (TCC_EVCTRL) Match or Capture Channel 7 Event Output Enable Mask */
#define TCC_EVCTRL_MCEO7(value)               (TCC_EVCTRL_MCEO7_Msk & (_UINT32_(value) << TCC_EVCTRL_MCEO7_Pos)) /* Assigment of value for MCEO7 in the TCC_EVCTRL register */
#define TCC_EVCTRL_Msk                        _UINT32_(0xFFFFF7FF)                                 /* (TCC_EVCTRL) Register Mask  */
...
#define TCC_EVCTRL_MCEI_Msk                   (_UINT32_(0xFF) << TCC_EVCTRL_MCEI_Pos)              /* (TCC_EVCTRL Mask) MCEI */
#define TCC_EVCTRL_MCEI(value)                (TCC_EVCTRL_MCEI_Msk & (_UINT32_(value) << TCC_EVCTRL_MCEI_Pos)) 
#define TCC_EVCTRL_MCEO_Pos                   _UINT32_(24)                                         /* (TCC_EVCTRL Position) Match or Capture Channel 7 Event Output Enable */
#define TCC_EVCTRL_MCEO_Msk                   (_UINT32_(0xFF) << TCC_EVCTRL_MCEO_Pos)              /* (TCC_EVCTRL Mask) MCEO */
...
#define TCC_INTENCLR_MC6_Pos                  _UINT32_(22)                                         /* (TCC_INTENCLR) Match or Capture Channel 6 Interrupt Enable Position */
#define TCC_INTENCLR_MC6_Msk                  (_UINT32_(0x1) << TCC_INTENCLR_MC6_Pos)              /* (TCC_INTENCLR) Match or Capture Channel 6 Interrupt Enable Mask */
#define TCC_INTENCLR_MC6(value)               (TCC_INTENCLR_MC6_Msk & (_UINT32_(value) << TCC_INTENCLR_MC6_Pos)) /* Assigment of value for MC6 in the TCC_INTENCLR register */
#define TCC_INTENCLR_MC7_Pos                  _UINT32_(23)                                         /* (TCC_INTENCLR) Match or Capture Channel 7 Interrupt Enable Position */
#define TCC_INTENCLR_MC7_Msk                  (_UINT32_(0x1) << TCC_INTENCLR_MC7_Pos)              /* (TCC_INTENCLR) Match or Capture Channel 7 Interrupt Enable Mask */
#define TCC_INTENCLR_MC7(value)               (TCC_INTENCLR_MC7_Msk & (_UINT32_(value) << TCC_INTENCLR_MC7_Pos)) /* Assigment of value for MC7 in the TCC_INTENCLR register */
#define TCC_INTENCLR_Msk                      _UINT32_(0x00FFFC0F)                                 /* (TCC_INTENCLR) Register Mask  */
...
#define TCC_INTENCLR_MC_Pos                   _UINT32_(16)                                         /* (TCC_INTENCLR Position) Match or Capture Channel 7 Interrupt Enable */
#define TCC_INTENCLR_MC_Msk                   (_UINT32_(0xFF) << TCC_INTENCLR_MC_Pos)              /* (TCC_INTENCLR Mask) MC */
...
#define TCC_INTENSET_MC6_Pos                  _UINT32_(22)                                         /* (TCC_INTENSET) Match or Capture Channel 6 Interrupt Enable Position */
#define TCC_INTENSET_MC6_Msk                  (_UINT32_(0x1) << TCC_INTENSET_MC6_Pos)              /* (TCC_INTENSET) Match or Capture Channel 6 Interrupt Enable Mask */
#define TCC_INTENSET_MC6(value)               (TCC_INTENSET_MC6_Msk & (_UINT32_(value) << TCC_INTENSET_MC6_Pos)) /* Assigment of value for MC6 in the TCC_INTENSET register */
#define TCC_INTENSET_MC7_Pos                  _UINT32_(23)                                         /* (TCC_INTENSET) Match or Capture Channel 7 Interrupt Enable Position */
#define TCC_INTENSET_MC7_Msk                  (_UINT32_(0x1) << TCC_INTENSET_MC7_Pos)              /* (TCC_INTENSET) Match or Capture Channel 7 Interrupt Enable Mask */
#define TCC_INTENSET_MC7(value)               (TCC_INTENSET_MC7_Msk & (_UINT32_(value) << TCC_INTENSET_MC7_Pos)) /* Assigment of value for MC7 in the TCC_INTENSET register */
#define TCC_INTENSET_Msk                      _UINT32_(0x00FFFC0F)                                 /* (TCC_INTENSET) Register Mask  */
...
#define TCC_INTENSET_MC_Pos                   _UINT32_(16)                                         /* (TCC_INTENSET Position) Match or Capture Channel 7 Interrupt Enable */
#define TCC_INTENSET_MC_Msk                   (_UINT32_(0xFF) << TCC_INTENSET_MC_Pos)              /* (TCC_INTENSET Mask) MC */
...
#define TCC_INTFLAG_MC6_Pos                   _UINT32_(22)                                         /* (TCC_INTFLAG) Match or Capture 6 Position */
#define TCC_INTFLAG_MC6_Msk                   (_UINT32_(0x1) << TCC_INTFLAG_MC6_Pos)               /* (TCC_INTFLAG) Match or Capture 6 Mask */
#define TCC_INTFLAG_MC6(value)                (TCC_INTFLAG_MC6_Msk & (_UINT32_(value) << TCC_INTFLAG_MC6_Pos)) /* Assigment of value for MC6 in the TCC_INTFLAG register */
#define TCC_INTFLAG_MC7_Pos                   _UINT32_(23)                                         /* (TCC_INTFLAG) Match or Capture 7 Position */
#define TCC_INTFLAG_MC7_Msk                   (_UINT32_(0x1) << TCC_INTFLAG_MC7_Pos)               /* (TCC_INTFLAG) Match or Capture 7 Mask */
#define TCC_INTFLAG_MC7(value)                (TCC_INTFLAG_MC7_Msk & (_UINT32_(value) << TCC_INTFLAG_MC7_Pos)) /* Assigment of value for MC7 in the TCC_INTFLAG register */
#define TCC_INTFLAG_Msk                       _UINT32_(0x00FFFC0F)                                 /* (TCC_INTFLAG) Register Mask  */
...
#define TCC_INTFLAG_MC_Pos                    _UINT32_(16)                                         /* (TCC_INTFLAG Position) Match or Capture 7 */
#define TCC_INTFLAG_MC_Msk                    (_UINT32_(0xFF) << TCC_INTFLAG_MC_Pos)               /* (TCC_INTFLAG Mask) MC */
...
#define TCC_STATUS_CCBUFV6_Pos                _UINT32_(22)                                         /* (TCC_STATUS) Compare Channel 6 Buffer Valid Position */
#define TCC_STATUS_CCBUFV6_Msk                (_UINT32_(0x1) << TCC_STATUS_CCBUFV6_Pos)            /* (TCC_STATUS) Compare Channel 6 Buffer Valid Mask */
#define TCC_STATUS_CCBUFV6(value)             (TCC_STATUS_CCBUFV6_Msk & (_UINT32_(value) << TCC_STATUS_CCBUFV6_Pos)) /* Assigment of value for CCBUFV6 in the TCC_STATUS register */
#define TCC_STATUS_CCBUFV7_Pos                _UINT32_(23)                                         /* (TCC_STATUS) Compare Channel 7 Buffer Valid Position */
#define TCC_STATUS_CCBUFV7_Msk                (_UINT32_(0x1) << TCC_STATUS_CCBUFV7_Pos)            /* (TCC_STATUS) Compare Channel 7 Buffer Valid Mask */
#define TCC_STATUS_CCBUFV7(value)             (TCC_STATUS_CCBUFV7_Msk & (_UINT32_(value) << TCC_STATUS_CCBUFV7_Pos)) /* Assigment of value for CCBUFV7 in the TCC_STATUS register */
...
#define TCC_STATUS_CMP6_Pos                   _UINT32_(30)                                         /* (TCC_STATUS) Compare Channel 6 Value Position */
#define TCC_STATUS_CMP6_Msk                   (_UINT32_(0x1) << TCC_STATUS_CMP6_Pos)               /* (TCC_STATUS) Compare Channel 6 Value Mask */
#define TCC_STATUS_CMP6(value)                (TCC_STATUS_CMP6_Msk & (_UINT32_(value) << TCC_STATUS_CMP6_Pos)) /* Assigment of value for CMP6 in the TCC_STATUS register */
#define TCC_STATUS_CMP7_Pos                   _UINT32_(31)                                         /* (TCC_STATUS) Compare Channel 7 Value Position */
#define TCC_STATUS_CMP7_Msk                   (_UINT32_(0x1) << TCC_STATUS_CMP7_Pos)               /* (TCC_STATUS) Compare Channel 7 Value Mask */
#define TCC_STATUS_CMP7(value)                (TCC_STATUS_CMP7_Msk & (_UINT32_(value) << TCC_STATUS_CMP7_Pos)) /* Assigment of value for CMP7 in the TCC_STATUS register */
#define TCC_STATUS_Msk                        _UINT32_(0xFFFFFFBF)                                 /* (TCC_STATUS) Register Mask  */
...
#define TCC_STATUS_CCBUFV_Msk                 (_UINT32_(0xFF) << TCC_STATUS_CCBUFV_Pos)            /* (TCC_STATUS Mask) CCBUFV */
#define TCC_STATUS_CCBUFV(value)              (TCC_STATUS_CCBUFV_Msk & (_UINT32_(value) << TCC_STATUS_CCBUFV_Pos)) 
#define TCC_STATUS_CMP_Pos                    _UINT32_(24)                                         /* (TCC_STATUS Position) Compare Channel 7 Value */
#define TCC_STATUS_CMP_Msk                    (_UINT32_(0xFF) << TCC_STATUS_CMP_Pos)               /* (TCC_STATUS Mask) CMP */
...
#define TCC_COUNT_COUNT_Msk                   (_UINT32_(0xFFFFFFFF) << TCC_COUNT_COUNT_Pos)        /* (TCC_COUNT) Counter Value Mask */
...
#define TCC_COUNT_Msk                         _UINT32_(0xFFFFFFFF)                                 /* (TCC_COUNT) Register Mask  */

/* DITH4 mode */
#define TCC_COUNT_DITH4_COUNT_Pos             _UINT32_(4)                                          /* (TCC_COUNT) Counter Value Position */
#define TCC_COUNT_DITH4_COUNT_Msk             (_UINT32_(0xFFFFFFF) << TCC_COUNT_DITH4_COUNT_Pos)   /* (TCC_COUNT) Counter Value Mask */
#define TCC_COUNT_DITH4_COUNT(value)          (TCC_COUNT_DITH4_COUNT_Msk & (_UINT32_(value) << TCC_COUNT_DITH4_COUNT_Pos))
#define TCC_COUNT_DITH4_Msk                   _UINT32_(0xFFFFFFF0)                                  /* (TCC_COUNT_DITH4) Register Mask  */

/* DITH5 mode */
#define TCC_COUNT_DITH5_COUNT_Pos             _UINT32_(5)                                          /* (TCC_COUNT) Counter Value Position */
#define TCC_COUNT_DITH5_COUNT_Msk             (_UINT32_(0x7FFFFFF) << TCC_COUNT_DITH5_COUNT_Pos)   /* (TCC_COUNT) Counter Value Mask */
#define TCC_COUNT_DITH5_COUNT(value)          (TCC_COUNT_DITH5_COUNT_Msk & (_UINT32_(value) << TCC_COUNT_DITH5_COUNT_Pos))
#define TCC_COUNT_DITH5_Msk                   _UINT32_(0xFFFFFFE0)                                  /* (TCC_COUNT_DITH5) Register Mask  */

/* DITH6 mode */
#define TCC_COUNT_DITH6_COUNT_Pos             _UINT32_(6)                                          /* (TCC_COUNT) Counter Value Position */
#define TCC_COUNT_DITH6_COUNT_Msk             (_UINT32_(0x3FFFFFF) << TCC_COUNT_DITH6_COUNT_Pos)   /* (TCC_COUNT) Counter Value Mask */
#define TCC_COUNT_DITH6_COUNT(value)          (TCC_COUNT_DITH6_COUNT_Msk & (_UINT32_(value) << TCC_COUNT_DITH6_COUNT_Pos))
#define TCC_COUNT_DITH6_Msk                   _UINT32_(0xFFFFFFC0)                                  /* (TCC_COUNT_DITH6) Register Mask  */
...
#define   TCC_WAVE_WAVEGEN_DPWM_Val           _UINT32_(0x3)                                        /* (TCC_WAVE) Dual compare PWM  */
...
#define TCC_WAVE_WAVEGEN_DPWM                 (TCC_WAVE_WAVEGEN_DPWM_Val << TCC_WAVE_WAVEGEN_Pos)  /* (TCC_WAVE) Dual compare PWM Position  */
...
#define   TCC_WAVE_RAMP_RAMP2CS_Val           _UINT32_(0x4)                                        /* (TCC_WAVE) Critical Swapped RAMP2 operation  */
...
#define TCC_WAVE_RAMP_RAMP2CS                 (TCC_WAVE_RAMP_RAMP2CS_Val << TCC_WAVE_RAMP_Pos)     /* (TCC_WAVE) Critical Swapped RAMP2 operation Position  */
...
#define TCC_WAVE_POL6_Pos                     _UINT32_(22)                                         /* (TCC_WAVE) Channel 6 Polarity Position */
#define TCC_WAVE_POL6_Msk                     (_UINT32_(0x1) << TCC_WAVE_POL6_Pos)                 /* (TCC_WAVE) Channel 6 Polarity Mask */
#define TCC_WAVE_POL6(value)                  (TCC_WAVE_POL6_Msk & (_UINT32_(value) << TCC_WAVE_POL6_Pos)) /* Assigment of value for POL6 in the TCC_WAVE register */
#define TCC_WAVE_POL7_Pos                     _UINT32_(23)                                         /* (TCC_WAVE) Channel 7 Polarity Position */
#define TCC_WAVE_POL7_Msk                     (_UINT32_(0x1) << TCC_WAVE_POL7_Pos)                 /* (TCC_WAVE) Channel 7 Polarity Mask */
#define TCC_WAVE_POL7(value)                  (TCC_WAVE_POL7_Msk & (_UINT32_(value) << TCC_WAVE_POL7_Pos)) /* Assigment of value for POL7 in the TCC_WAVE register */
...
#define TCC_WAVE_POL_Msk                      (_UINT32_(0xFF) << TCC_WAVE_POL_Pos)                 /* (TCC_WAVE Mask) POL */
...
#define TCC_PER_PER_Msk                       (_UINT32_(0xFFFFFFFF) << TCC_PER_PER_Pos)            /* (TCC_PER) Period Value Mask */
...
#define TCC_PER_Msk                           _UINT32_(0xFFFFFFFF)                                 /* (TCC_PER) Register Mask  */
...
#define TCC_PER_DITH4_PER_Msk                 (_UINT32_(0xFFFFFFF) << TCC_PER_DITH4_PER_Pos)       /* (TCC_PER) Period Value Mask */
#define TCC_PER_DITH4_PER(value)              (TCC_PER_DITH4_PER_Msk & (_UINT32_(value) << TCC_PER_DITH4_PER_Pos))
#define TCC_PER_DITH4_Msk                     _UINT32_(0xFFFFFFFF)                                  /* (TCC_PER_DITH4) Register Mask  */
...
#define TCC_PER_DITH5_PER_Msk                 (_UINT32_(0x7FFFFFF) << TCC_PER_DITH5_PER_Pos)       /* (TCC_PER) Period Value Mask */
#define TCC_PER_DITH5_PER(value)              (TCC_PER_DITH5_PER_Msk & (_UINT32_(value) << TCC_PER_DITH5_PER_Pos))
#define TCC_PER_DITH5_Msk                     _UINT32_(0xFFFFFFFF)                                  /* (TCC_PER_DITH5) Register Mask  */
...
#define TCC_PER_DITH6_PER_Msk                 (_UINT32_(0x3FFFFFF) << TCC_PER_DITH6_PER_Pos)       /* (TCC_PER) Period Value Mask */
#define TCC_PER_DITH6_PER(value)              (TCC_PER_DITH6_PER_Msk & (_UINT32_(value) << TCC_PER_DITH6_PER_Pos))
#define TCC_PER_DITH6_Msk                     _UINT32_(0xFFFFFFFF)                                  /* (TCC_PER_DITH6) Register Mask  */
...
#define TCC_CC_CC_Msk                         (_UINT32_(0xFFFFFFFF) << TCC_CC_CC_Pos)              /* (TCC_CC) Channel Compare/Capture Value Mask */
#define TCC_CC_CC(value)                      (TCC_CC_CC_Msk & (_UINT32_(value) << TCC_CC_CC_Pos)) /* Assigment of value for CC in the TCC_CC register */
#define TCC_CC_Msk                            _UINT32_(0xFFFFFFFF)                                 /* (TCC_CC) Register Mask  */
...
#define TCC_CC_DITH4_CC_Msk                   (_UINT32_(0xFFFFFFF) << TCC_CC_DITH4_CC_Pos)         /* (TCC_CC) Channel Compare/Capture Value Mask */
#define TCC_CC_DITH4_CC(value)                (TCC_CC_DITH4_CC_Msk & (_UINT32_(value) << TCC_CC_DITH4_CC_Pos))
#define TCC_CC_DITH4_Msk                      _UINT32_(0xFFFFFFFF)                                  /* (TCC_CC_DITH4) Register Mask  */
...
#define TCC_CC_DITH5_CC_Msk                   (_UINT32_(0x7FFFFFF) << TCC_CC_DITH5_CC_Pos)         /* (TCC_CC) Channel Compare/Capture Value Mask */
#define TCC_CC_DITH5_CC(value)                (TCC_CC_DITH5_CC_Msk & (_UINT32_(value) << TCC_CC_DITH5_CC_Pos))
#define TCC_CC_DITH5_Msk                      _UINT32_(0xFFFFFFFF)                                  /* (TCC_CC_DITH5) Register Mask  */
...
#define TCC_CC_DITH6_CC_Msk                   (_UINT32_(0x3FFFFFF) << TCC_CC_DITH6_CC_Pos)         /* (TCC_CC) Channel Compare/Capture Value Mask */
#define TCC_CC_DITH6_CC(value)                (TCC_CC_DITH6_CC_Msk & (_UINT32_(value) << TCC_CC_DITH6_CC_Pos))
#define TCC_CC_DITH6_Msk                      _UINT32_(0xFFFFFFFF)                                  /* (TCC_CC_DITH6) Register Mask  */
...
#define TCC_PATTBUF_PGEB0_Pos                 _UINT16_(0)                                          /* (TCC_PATTBUF) Pattern Generation 0 Output Enable Buffer Position */
#define TCC_PATTBUF_PGEB0_Msk                 (_UINT16_(0x1) << TCC_PATTBUF_PGEB0_Pos)             /* (TCC_PATTBUF) Pattern Generation 0 Output Enable Buffer Mask */
...
#define TCC_PATTBUF_PGEB1_Pos                 _UINT16_(1)                                          /* (TCC_PATTBUF) Pattern Generation 1 Output Enable Buffer Position */
#define TCC_PATTBUF_PGEB1_Msk                 (_UINT16_(0x1) << TCC_PATTBUF_PGEB1_Pos)             /* (TCC_PATTBUF) Pattern Generation 1 Output Enable Buffer Mask */
...
#define TCC_PATTBUF_PGEB2_Pos                 _UINT16_(2)                                          /* (TCC_PATTBUF) Pattern Generation 2 Output Enable Buffer Position */
#define TCC_PATTBUF_PGEB2_Msk                 (_UINT16_(0x1) << TCC_PATTBUF_PGEB2_Pos)             /* (TCC_PATTBUF) Pattern Generation 2 Output Enable Buffer Mask */
...
#define TCC_PATTBUF_PGEB3_Pos                 _UINT16_(3)                                          /* (TCC_PATTBUF) Pattern Generation 3 Output Enable Buffer Position */
#define TCC_PATTBUF_PGEB3_Msk                 (_UINT16_(0x1) << TCC_PATTBUF_PGEB3_Pos)             /* (TCC_PATTBUF) Pattern Generation 3 Output Enable Buffer Mask */
...
#define TCC_PATTBUF_PGEB4_Pos                 _UINT16_(4)                                          /* (TCC_PATTBUF) Pattern Generation 4 Output Enable Buffer Position */
#define TCC_PATTBUF_PGEB4_Msk                 (_UINT16_(0x1) << TCC_PATTBUF_PGEB4_Pos)             /* (TCC_PATTBUF) Pattern Generation 4 Output Enable Buffer Mask */
...
#define TCC_PATTBUF_PGEB5_Pos                 _UINT16_(5)                                          /* (TCC_PATTBUF) Pattern Generation 5 Output Enable Buffer Position */
#define TCC_PATTBUF_PGEB5_Msk                 (_UINT16_(0x1) << TCC_PATTBUF_PGEB5_Pos)             /* (TCC_PATTBUF) Pattern Generation 5 Output Enable Buffer Mask */
...
#define TCC_PATTBUF_PGEB6_Pos                 _UINT16_(6)                                          /* (TCC_PATTBUF) Pattern Generation 6 Output Enable Buffer Position */
#define TCC_PATTBUF_PGEB6_Msk                 (_UINT16_(0x1) << TCC_PATTBUF_PGEB6_Pos)             /* (TCC_PATTBUF) Pattern Generation 6 Output Enable Buffer Mask */
...
#define TCC_PATTBUF_PGEB7_Pos                 _UINT16_(7)                                          /* (TCC_PATTBUF) Pattern Generation 7 Output Enable Buffer Position */
#define TCC_PATTBUF_PGEB7_Msk                 (_UINT16_(0x1) << TCC_PATTBUF_PGEB7_Pos)             /* (TCC_PATTBUF) Pattern Generation 7 Output Enable Buffer Mask */
...
#define TCC_PATTBUF_PGVB0_Pos                 _UINT16_(8)                                          /* (TCC_PATTBUF) Pattern Generation 0 Output Value Buffer Position */
#define TCC_PATTBUF_PGVB0_Msk                 (_UINT16_(0x1) << TCC_PATTBUF_PGVB0_Pos)             /* (TCC_PATTBUF) Pattern Generation 0 Output Value Buffer Mask */
...
#define TCC_PATTBUF_PGVB1_Pos                 _UINT16_(9)                                          /* (TCC_PATTBUF) Pattern Generation 1 Output Value Buffer Position */
#define TCC_PATTBUF_PGVB1_Msk                 (_UINT16_(0x1) << TCC_PATTBUF_PGVB1_Pos)             /* (TCC_PATTBUF) Pattern Generation 1 Output Value Buffer Mask */
...
#define TCC_PATTBUF_PGVB2_Pos                 _UINT16_(10)                                         /* (TCC_PATTBUF) Pattern Generation 2 Output Value Buffer Position */
#define TCC_PATTBUF_PGVB2_Msk                 (_UINT16_(0x1) << TCC_PATTBUF_PGVB2_Pos)             /* (TCC_PATTBUF) Pattern Generation 2 Output Value Buffer Mask */
...
#define TCC_PATTBUF_PGVB3_Pos                 _UINT16_(11)                                         /* (TCC_PATTBUF) Pattern Generation 3 Output Value Buffer Position */
#define TCC_PATTBUF_PGVB3_Msk                 (_UINT16_(0x1) << TCC_PATTBUF_PGVB3_Pos)             /* (TCC_PATTBUF) Pattern Generation 3 Output Value Buffer Mask */
...
#define TCC_PATTBUF_PGVB4_Pos                 _UINT16_(12)                                         /* (TCC_PATTBUF) Pattern Generation 4 Output Value Buffer Position */
#define TCC_PATTBUF_PGVB4_Msk                 (_UINT16_(0x1) << TCC_PATTBUF_PGVB4_Pos)             /* (TCC_PATTBUF) Pattern Generation 4 Output Value Buffer Mask */
...
#define TCC_PATTBUF_PGVB5_Pos                 _UINT16_(13)                                         /* (TCC_PATTBUF) Pattern Generation 5 Output Value Buffer Position */
#define TCC_PATTBUF_PGVB5_Msk                 (_UINT16_(0x1) << TCC_PATTBUF_PGVB5_Pos)             /* (TCC_PATTBUF) Pattern Generation 5 Output Value Buffer Mask */
...
#define TCC_PATTBUF_PGVB6_Pos                 _UINT16_(14)                                         /* (TCC_PATTBUF) Pattern Generation 6 Output Value Buffer Position */
#define TCC_PATTBUF_PGVB6_Msk                 (_UINT16_(0x1) << TCC_PATTBUF_PGVB6_Pos)             /* (TCC_PATTBUF) Pattern Generation 6 Output Value Buffer Mask */
...
#define TCC_PATTBUF_PGVB7_Pos                 _UINT16_(15)                                         /* (TCC_PATTBUF) Pattern Generation 7 Output Value Buffer Position */
#define TCC_PATTBUF_PGVB7_Msk                 (_UINT16_(0x1) << TCC_PATTBUF_PGVB7_Pos)             /* (TCC_PATTBUF) Pattern Generation 7 Output Value Buffer Mask */
...
#define TCC_PATTBUF_PGEB_Pos                  _UINT16_(0)                                          /* (TCC_PATTBUF Position) Pattern Generation x Output Enable Buffer */
...
#define TCC_PATTBUF_PGVB_Pos                  _UINT16_(8)                                          /* (TCC_PATTBUF Position) Pattern Generation 7 Output Value Buffer */
...
#define TCC_PERBUF_PERBUF_Msk                 (_UINT32_(0xFFFFFFFF) << TCC_PERBUF_PERBUF_Pos)      /* (TCC_PERBUF) Period Buffer Value Mask */
...
#define TCC_PERBUF_Msk                        _UINT32_(0xFFFFFFFF)                                 /* (TCC_PERBUF) Register Mask  */
...
#define TCC_PERBUF_DITH4_PERBUF_Msk           (_UINT32_(0xFFFFFFF) << TCC_PERBUF_DITH4_PERBUF_Pos) /* (TCC_PERBUF) Period Buffer Value Mask */
#define TCC_PERBUF_DITH4_PERBUF(value)        (TCC_PERBUF_DITH4_PERBUF_Msk & (_UINT32_(value) << TCC_PERBUF_DITH4_PERBUF_Pos))
#define TCC_PERBUF_DITH4_Msk                  _UINT32_(0xFFFFFFFF)                                  /* (TCC_PERBUF_DITH4) Register Mask  */
...
#define TCC_PERBUF_DITH5_PERBUF_Msk           (_UINT32_(0x7FFFFFF) << TCC_PERBUF_DITH5_PERBUF_Pos) /* (TCC_PERBUF) Period Buffer Value Mask */
#define TCC_PERBUF_DITH5_PERBUF(value)        (TCC_PERBUF_DITH5_PERBUF_Msk & (_UINT32_(value) << TCC_PERBUF_DITH5_PERBUF_Pos))
#define TCC_PERBUF_DITH5_Msk                  _UINT32_(0xFFFFFFFF)                                  /* (TCC_PERBUF_DITH5) Register Mask  */
...
#define TCC_PERBUF_DITH6_PERBUF_Msk           (_UINT32_(0x3FFFFFF) << TCC_PERBUF_DITH6_PERBUF_Pos) /* (TCC_PERBUF) Period Buffer Value Mask */
#define TCC_PERBUF_DITH6_PERBUF(value)        (TCC_PERBUF_DITH6_PERBUF_Msk & (_UINT32_(value) << TCC_PERBUF_DITH6_PERBUF_Pos))
#define TCC_PERBUF_DITH6_Msk                  _UINT32_(0xFFFFFFFF)                                  /* (TCC_PERBUF_DITH6) Register Mask  */
...
#define TCC_CCBUF_CCBUF_Msk                   (_UINT32_(0xFFFFFFFF) << TCC_CCBUF_CCBUF_Pos)        /* (TCC_CCBUF) Channel Compare/Capture Buffer Value Mask */
...
#define TCC_CCBUF_Msk                         _UINT32_(0xFFFFFFFF)                                 /* (TCC_CCBUF) Register Mask  */

/* DITH4 mode */
#define TCC_CCBUF_DITH4_DITHERBUF_Pos         _UINT32_(0)                                          /* (TCC_CCBUF) Channel Compare/Capture Buffer Value Position */
#define TCC_CCBUF_DITH4_DITHERBUF_Msk         (_UINT32_(0xF) << TCC_CCBUF_DITH4_DITHERBUF_Pos)     /* (TCC_CCBUF) Channel Compare/Capture Buffer Value Mask */
#define TCC_CCBUF_DITH4_DITHERBUF(value)      (TCC_CCBUF_DITH4_DITHERBUF_Msk & (_UINT32_(value) << TCC_CCBUF_DITH4_DITHERBUF_Pos))
#define TCC_CCBUF_DITH4_CCBUF_Pos             _UINT32_(4)                                          /* (TCC_CCBUF) Dithering Buffer Cycle Number Position */
#define TCC_CCBUF_DITH4_CCBUF_Msk             (_UINT32_(0xFFFFFFF) << TCC_CCBUF_DITH4_CCBUF_Pos)   /* (TCC_CCBUF) Dithering Buffer Cycle Number Mask */
#define TCC_CCBUF_DITH4_CCBUF(value)          (TCC_CCBUF_DITH4_CCBUF_Msk & (_UINT32_(value) << TCC_CCBUF_DITH4_CCBUF_Pos))
#define TCC_CCBUF_DITH4_Msk                   _UINT32_(0xFFFFFFFF)                                  /* (TCC_CCBUF_DITH4) Register Mask  */
...
#define TCC_CCBUF_DITH5_CCBUF_Msk             (_UINT32_(0x7FFFFFF) << TCC_CCBUF_DITH5_CCBUF_Pos)   /* (TCC_CCBUF) Channel Compare/Capture Buffer Value Mask */
#define TCC_CCBUF_DITH5_CCBUF(value)          (TCC_CCBUF_DITH5_CCBUF_Msk & (_UINT32_(value) << TCC_CCBUF_DITH5_CCBUF_Pos))
#define TCC_CCBUF_DITH5_Msk                   _UINT32_(0xFFFFFFFF)                                  /* (TCC_CCBUF_DITH5) Register Mask  */
...
#define TCC_CCBUF_DITH6_CCBUF_Msk             (_UINT32_(0x3FFFFFF) << TCC_CCBUF_DITH6_CCBUF_Pos)   /* (TCC_CCBUF) Channel Compare/Capture Buffer Value Mask */
#define TCC_CCBUF_DITH6_CCBUF(value)          (TCC_CCBUF_DITH6_CCBUF_Msk & (_UINT32_(value) << TCC_CCBUF_DITH6_CCBUF_Pos))
#define TCC_CCBUF_DITH6_Msk                   _UINT32_(0xFFFFFFFF)                                  /* (TCC_CCBUF_DITH6) Register Mask  */
...
#define TCC_CC6_REG_OFST               _UINT32_(0x5C)      /* (TCC_CC6) Compare and Capture Offset */
#define TCC_CC7_REG_OFST               _UINT32_(0x60)      /* (TCC_CC7) Compare and Capture Offset */
...
#define TCC_CCBUF6_REG_OFST            _UINT32_(0x88)      /* (TCC_CCBUF6) Compare and Capture Buffer Offset */
#define TCC_CCBUF7_REG_OFST            _UINT32_(0x8C)      /* (TCC_CCBUF7) Compare and Capture Buffer Offset */
...
{  /* Timer Counter for Control Applications */
  ...
  __IO  uint32_t                       TCC_CC[8];          /**< Offset: 0x44 (R/W  32) Compare and Capture */
  ...
  __IO  uint32_t                       TCC_CCBUF[8];       /**< Offset: 0x70 (R/W  32) Compare and Capture Buffer */
} tcc_registers_t;


#endif /* !(defined(__ASSEMBLER__) || defined(__IAR_SYSTEMS_ASM__)) */
#endif /* _PIC32CZCA90_TCC_COMPONENT_H_ */
