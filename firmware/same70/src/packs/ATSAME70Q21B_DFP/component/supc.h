...
#define SUPC_MR_ONREG(value)                  (SUPC_MR_ONREG_Msk & (_UINT32_(value) << SUPC_MR_ONREG_Pos)) /* Assigment of value for ONREG in the SUPC_MR register */
...
#define SUPC_MR_BKUPRETON(value)              (SUPC_MR_BKUPRETON_Msk & (_UINT32_(value) << SUPC_MR_BKUPRETON_Pos)) /* Assigment of value for BKUPRETON in the SUPC_MR register */
...
#define SUPC_WUMR_SMEN(value)                 (SUPC_WUMR_SMEN_Msk & (_UINT32_(value) << SUPC_WUMR_SMEN_Pos)) /* Assigment of value for SMEN in the SUPC_WUMR register */
...
#define SUPC_WUMR_RTTEN(value)                (SUPC_WUMR_RTTEN_Msk & (_UINT32_(value) << SUPC_WUMR_RTTEN_Pos)) /* Assigment of value for RTTEN in the SUPC_WUMR register */
...
#define SUPC_WUMR_RTCEN(value)                (SUPC_WUMR_RTCEN_Msk & (_UINT32_(value) << SUPC_WUMR_RTCEN_Pos)) /* Assigment of value for RTCEN in the SUPC_WUMR register */
...
#define SUPC_WUMR_LPDBCCLR(value)             (SUPC_WUMR_LPDBCCLR_Msk & (_UINT32_(value) << SUPC_WUMR_LPDBCCLR_Pos)) /* Assigment of value for LPDBCCLR in the SUPC_WUMR register */
...
#define SUPC_WUMR_LPDBC(value)                (SUPC_WUMR_LPDBC_Msk & (_UINT32_(value) << SUPC_WUMR_LPDBC_Pos)) /* Assigment of value for LPDBC in the SUPC_WUMR register */
...
#define SUPC_SR_SMWS(value)                   (SUPC_SR_SMWS_Msk & (_UINT32_(value) << SUPC_SR_SMWS_Pos)) /* Assigment of value for SMWS in the SUPC_SR register */
...
#define SUPC_SR_WKUPIS0(value)                (SUPC_SR_WKUPIS0_Msk & (_UINT32_(value) << SUPC_SR_WKUPIS0_Pos)) /* Assigment of value for WKUPIS0 in the SUPC_SR register */
...
#define SUPC_SR_WKUPIS1(value)                (SUPC_SR_WKUPIS1_Msk & (_UINT32_(value) << SUPC_SR_WKUPIS1_Pos)) /* Assigment of value for WKUPIS1 in the SUPC_SR register */
...
#define SUPC_SR_WKUPIS2(value)                (SUPC_SR_WKUPIS2_Msk & (_UINT32_(value) << SUPC_SR_WKUPIS2_Pos)) /* Assigment of value for WKUPIS2 in the SUPC_SR register */
...
#define SUPC_SR_WKUPIS3(value)                (SUPC_SR_WKUPIS3_Msk & (_UINT32_(value) << SUPC_SR_WKUPIS3_Pos)) /* Assigment of value for WKUPIS3 in the SUPC_SR register */
...
#define SUPC_SR_WKUPIS4(value)                (SUPC_SR_WKUPIS4_Msk & (_UINT32_(value) << SUPC_SR_WKUPIS4_Pos)) /* Assigment of value for WKUPIS4 in the SUPC_SR register */
...
#define SUPC_SR_WKUPIS5(value)                (SUPC_SR_WKUPIS5_Msk & (_UINT32_(value) << SUPC_SR_WKUPIS5_Pos)) /* Assigment of value for WKUPIS5 in the SUPC_SR register */
...
#define SUPC_SR_WKUPIS6(value)                (SUPC_SR_WKUPIS6_Msk & (_UINT32_(value) << SUPC_SR_WKUPIS6_Pos)) /* Assigment of value for WKUPIS6 in the SUPC_SR register */
...
#define SUPC_SR_WKUPIS7(value)                (SUPC_SR_WKUPIS7_Msk & (_UINT32_(value) << SUPC_SR_WKUPIS7_Pos)) /* Assigment of value for WKUPIS7 in the SUPC_SR register */
...
#define SUPC_SR_WKUPIS8(value)                (SUPC_SR_WKUPIS8_Msk & (_UINT32_(value) << SUPC_SR_WKUPIS8_Pos)) /* Assigment of value for WKUPIS8 in the SUPC_SR register */
...
#define SUPC_SR_WKUPIS9(value)                (SUPC_SR_WKUPIS9_Msk & (_UINT32_(value) << SUPC_SR_WKUPIS9_Pos)) /* Assigment of value for WKUPIS9 in the SUPC_SR register */
...
#define SUPC_SR_WKUPIS10(value)               (SUPC_SR_WKUPIS10_Msk & (_UINT32_(value) << SUPC_SR_WKUPIS10_Pos)) /* Assigment of value for WKUPIS10 in the SUPC_SR register */
...
#define SUPC_SR_WKUPIS11(value)               (SUPC_SR_WKUPIS11_Msk & (_UINT32_(value) << SUPC_SR_WKUPIS11_Pos)) /* Assigment of value for WKUPIS11 in the SUPC_SR register */
...
#define SUPC_SR_WKUPIS12(value)               (SUPC_SR_WKUPIS12_Msk & (_UINT32_(value) << SUPC_SR_WKUPIS12_Pos)) /* Assigment of value for WKUPIS12 in the SUPC_SR register */
...
#define SUPC_SR_WKUPIS13(value)               (SUPC_SR_WKUPIS13_Msk & (_UINT32_(value) << SUPC_SR_WKUPIS13_Pos)) /* Assigment of value for WKUPIS13 in the SUPC_SR register */
...
#define SYSC_WPMR_WPEN(value)                 (SYSC_WPMR_WPEN_Msk & (_UINT32_(value) << SYSC_WPMR_WPEN_Pos)) /* Assigment of value for WPEN in the SYSC_WPMR register */
...
#define SYSC_WPMR_WPKEY(value)                (SYSC_WPMR_WPKEY_Msk & (_UINT32_(value) << SYSC_WPMR_WPKEY_Pos)) /* Assigment of value for WPKEY in the SYSC_WPMR register */
