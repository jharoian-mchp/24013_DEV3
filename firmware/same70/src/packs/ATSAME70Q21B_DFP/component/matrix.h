...
#define MATRIX_PRAS_Msk                       _UINT32_(0x03333333)                                 /* (MATRIX_PRAS) Register Mask  */
...
#define MATRIX_MRCR_Msk                       _UINT32_(0x00001F7F)                                 /* (MATRIX_MRCR) Register Mask  */

#define MATRIX_MRCR_RCB_Pos                   _UINT32_(0)                                          /* (MATRIX_MRCR Position) Remap Command Bit for Master x2 */
#define MATRIX_MRCR_RCB_Msk                   (_UINT32_(0xFFF) << MATRIX_MRCR_RCB_Pos)             /* (MATRIX_MRCR Mask) RCB */
