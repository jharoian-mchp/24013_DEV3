...
#define ISI_CFG1_HSYNC_POL(value)             (ISI_CFG1_HSYNC_POL_Msk & (_UINT32_(value) << ISI_CFG1_HSYNC_POL_Pos)) /* Assigment of value for HSYNC_POL in the ISI_CFG1 register */
...
#define ISI_CFG1_VSYNC_POL(value)             (ISI_CFG1_VSYNC_POL_Msk & (_UINT32_(value) << ISI_CFG1_VSYNC_POL_Pos)) /* Assigment of value for VSYNC_POL in the ISI_CFG1 register */
...
#define ISI_CFG1_PIXCLK_POL(value)            (ISI_CFG1_PIXCLK_POL_Msk & (_UINT32_(value) << ISI_CFG1_PIXCLK_POL_Pos)) /* Assigment of value for PIXCLK_POL in the ISI_CFG1 register */
...
#define ISI_CFG1_GRAYLE(value)                (ISI_CFG1_GRAYLE_Msk & (_UINT32_(value) << ISI_CFG1_GRAYLE_Pos)) /* Assigment of value for GRAYLE in the ISI_CFG1 register */
...
#define ISI_CFG1_EMB_SYNC(value)              (ISI_CFG1_EMB_SYNC_Msk & (_UINT32_(value) << ISI_CFG1_EMB_SYNC_Pos)) /* Assigment of value for EMB_SYNC in the ISI_CFG1 register */
...
#define ISI_CFG1_CRC_SYNC(value)              (ISI_CFG1_CRC_SYNC_Msk & (_UINT32_(value) << ISI_CFG1_CRC_SYNC_Pos)) /* Assigment of value for CRC_SYNC in the ISI_CFG1 register */
...
#define ISI_CFG1_FRATE(value)                 (ISI_CFG1_FRATE_Msk & (_UINT32_(value) << ISI_CFG1_FRATE_Pos)) /* Assigment of value for FRATE in the ISI_CFG1 register */
...
#define ISI_CFG1_DISCR(value)                 (ISI_CFG1_DISCR_Msk & (_UINT32_(value) << ISI_CFG1_DISCR_Pos)) /* Assigment of value for DISCR in the ISI_CFG1 register */
...
#define ISI_CFG1_FULL(value)                  (ISI_CFG1_FULL_Msk & (_UINT32_(value) << ISI_CFG1_FULL_Pos)) /* Assigment of value for FULL in the ISI_CFG1 register */
...
#define ISI_CFG1_THMASK(value)                (ISI_CFG1_THMASK_Msk & (_UINT32_(value) << ISI_CFG1_THMASK_Pos)) /* Assigment of value for THMASK in the ISI_CFG1 register */
...
#define ISI_CFG1_SLD(value)                   (ISI_CFG1_SLD_Msk & (_UINT32_(value) << ISI_CFG1_SLD_Pos)) /* Assigment of value for SLD in the ISI_CFG1 register */
...
#define ISI_CFG1_SFD(value)                   (ISI_CFG1_SFD_Msk & (_UINT32_(value) << ISI_CFG1_SFD_Pos)) /* Assigment of value for SFD in the ISI_CFG1 register */
...
#define ISI_CFG2_IM_VSIZE(value)              (ISI_CFG2_IM_VSIZE_Msk & (_UINT32_(value) << ISI_CFG2_IM_VSIZE_Pos)) /* Assigment of value for IM_VSIZE in the ISI_CFG2 register */
...
#define ISI_CFG2_GS_MODE(value)               (ISI_CFG2_GS_MODE_Msk & (_UINT32_(value) << ISI_CFG2_GS_MODE_Pos)) /* Assigment of value for GS_MODE in the ISI_CFG2 register */
...
#define ISI_CFG2_RGB_MODE(value)              (ISI_CFG2_RGB_MODE_Msk & (_UINT32_(value) << ISI_CFG2_RGB_MODE_Pos)) /* Assigment of value for RGB_MODE in the ISI_CFG2 register */
...
#define ISI_CFG2_GRAYSCALE(value)             (ISI_CFG2_GRAYSCALE_Msk & (_UINT32_(value) << ISI_CFG2_GRAYSCALE_Pos)) /* Assigment of value for GRAYSCALE in the ISI_CFG2 register */
...
#define ISI_CFG2_RGB_SWAP(value)              (ISI_CFG2_RGB_SWAP_Msk & (_UINT32_(value) << ISI_CFG2_RGB_SWAP_Pos)) /* Assigment of value for RGB_SWAP in the ISI_CFG2 register */
...
#define ISI_CFG2_COL_SPACE(value)             (ISI_CFG2_COL_SPACE_Msk & (_UINT32_(value) << ISI_CFG2_COL_SPACE_Pos)) /* Assigment of value for COL_SPACE in the ISI_CFG2 register */
...
#define ISI_CFG2_IM_HSIZE(value)              (ISI_CFG2_IM_HSIZE_Msk & (_UINT32_(value) << ISI_CFG2_IM_HSIZE_Pos)) /* Assigment of value for IM_HSIZE in the ISI_CFG2 register */
...
#define ISI_CFG2_YCC_SWAP(value)              (ISI_CFG2_YCC_SWAP_Msk & (_UINT32_(value) << ISI_CFG2_YCC_SWAP_Pos)) /* Assigment of value for YCC_SWAP in the ISI_CFG2 register */
...
#define ISI_CFG2_RGB_CFG(value)               (ISI_CFG2_RGB_CFG_Msk & (_UINT32_(value) << ISI_CFG2_RGB_CFG_Pos)) /* Assigment of value for RGB_CFG in the ISI_CFG2 register */
...
#define ISI_PSIZE_PREV_VSIZE(value)           (ISI_PSIZE_PREV_VSIZE_Msk & (_UINT32_(value) << ISI_PSIZE_PREV_VSIZE_Pos)) /* Assigment of value for PREV_VSIZE in the ISI_PSIZE register */
...
#define ISI_PSIZE_PREV_HSIZE(value)           (ISI_PSIZE_PREV_HSIZE_Msk & (_UINT32_(value) << ISI_PSIZE_PREV_HSIZE_Pos)) /* Assigment of value for PREV_HSIZE in the ISI_PSIZE register */
...
#define ISI_PDECF_DEC_FACTOR(value)           (ISI_PDECF_DEC_FACTOR_Msk & (_UINT32_(value) << ISI_PDECF_DEC_FACTOR_Pos)) /* Assigment of value for DEC_FACTOR in the ISI_PDECF register */
...
#define ISI_Y2R_SET0_C0(value)                (ISI_Y2R_SET0_C0_Msk & (_UINT32_(value) << ISI_Y2R_SET0_C0_Pos)) /* Assigment of value for C0 in the ISI_Y2R_SET0 register */
...
#define ISI_Y2R_SET0_C1(value)                (ISI_Y2R_SET0_C1_Msk & (_UINT32_(value) << ISI_Y2R_SET0_C1_Pos)) /* Assigment of value for C1 in the ISI_Y2R_SET0 register */
...
#define ISI_Y2R_SET0_C2(value)                (ISI_Y2R_SET0_C2_Msk & (_UINT32_(value) << ISI_Y2R_SET0_C2_Pos)) /* Assigment of value for C2 in the ISI_Y2R_SET0 register */
...
#define ISI_Y2R_SET0_C3(value)                (ISI_Y2R_SET0_C3_Msk & (_UINT32_(value) << ISI_Y2R_SET0_C3_Pos)) /* Assigment of value for C3 in the ISI_Y2R_SET0 register */
...
#define ISI_Y2R_SET1_C4(value)                (ISI_Y2R_SET1_C4_Msk & (_UINT32_(value) << ISI_Y2R_SET1_C4_Pos)) /* Assigment of value for C4 in the ISI_Y2R_SET1 register */
...
#define ISI_Y2R_SET1_Yoff(value)              (ISI_Y2R_SET1_Yoff_Msk & (_UINT32_(value) << ISI_Y2R_SET1_Yoff_Pos)) /* Assigment of value for Yoff in the ISI_Y2R_SET1 register */
...
#define ISI_Y2R_SET1_Croff(value)             (ISI_Y2R_SET1_Croff_Msk & (_UINT32_(value) << ISI_Y2R_SET1_Croff_Pos)) /* Assigment of value for Croff in the ISI_Y2R_SET1 register */
...
#define ISI_Y2R_SET1_Cboff(value)             (ISI_Y2R_SET1_Cboff_Msk & (_UINT32_(value) << ISI_Y2R_SET1_Cboff_Pos)) /* Assigment of value for Cboff in the ISI_Y2R_SET1 register */
...
#define ISI_R2Y_SET0_C0(value)                (ISI_R2Y_SET0_C0_Msk & (_UINT32_(value) << ISI_R2Y_SET0_C0_Pos)) /* Assigment of value for C0 in the ISI_R2Y_SET0 register */
...
#define ISI_R2Y_SET0_C1(value)                (ISI_R2Y_SET0_C1_Msk & (_UINT32_(value) << ISI_R2Y_SET0_C1_Pos)) /* Assigment of value for C1 in the ISI_R2Y_SET0 register */
...
#define ISI_R2Y_SET0_C2(value)                (ISI_R2Y_SET0_C2_Msk & (_UINT32_(value) << ISI_R2Y_SET0_C2_Pos)) /* Assigment of value for C2 in the ISI_R2Y_SET0 register */
...
#define ISI_R2Y_SET0_Roff(value)              (ISI_R2Y_SET0_Roff_Msk & (_UINT32_(value) << ISI_R2Y_SET0_Roff_Pos)) /* Assigment of value for Roff in the ISI_R2Y_SET0 register */
...
#define ISI_R2Y_SET1_C3(value)                (ISI_R2Y_SET1_C3_Msk & (_UINT32_(value) << ISI_R2Y_SET1_C3_Pos)) /* Assigment of value for C3 in the ISI_R2Y_SET1 register */
...
#define ISI_R2Y_SET1_C4(value)                (ISI_R2Y_SET1_C4_Msk & (_UINT32_(value) << ISI_R2Y_SET1_C4_Pos)) /* Assigment of value for C4 in the ISI_R2Y_SET1 register */
...
#define ISI_R2Y_SET1_C5(value)                (ISI_R2Y_SET1_C5_Msk & (_UINT32_(value) << ISI_R2Y_SET1_C5_Pos)) /* Assigment of value for C5 in the ISI_R2Y_SET1 register */
...
#define ISI_R2Y_SET1_Goff(value)              (ISI_R2Y_SET1_Goff_Msk & (_UINT32_(value) << ISI_R2Y_SET1_Goff_Pos)) /* Assigment of value for Goff in the ISI_R2Y_SET1 register */
...
#define ISI_R2Y_SET2_C6(value)                (ISI_R2Y_SET2_C6_Msk & (_UINT32_(value) << ISI_R2Y_SET2_C6_Pos)) /* Assigment of value for C6 in the ISI_R2Y_SET2 register */
...
#define ISI_R2Y_SET2_C7(value)                (ISI_R2Y_SET2_C7_Msk & (_UINT32_(value) << ISI_R2Y_SET2_C7_Pos)) /* Assigment of value for C7 in the ISI_R2Y_SET2 register */
...
#define ISI_R2Y_SET2_C8(value)                (ISI_R2Y_SET2_C8_Msk & (_UINT32_(value) << ISI_R2Y_SET2_C8_Pos)) /* Assigment of value for C8 in the ISI_R2Y_SET2 register */
...
#define ISI_R2Y_SET2_Boff(value)              (ISI_R2Y_SET2_Boff_Msk & (_UINT32_(value) << ISI_R2Y_SET2_Boff_Pos)) /* Assigment of value for Boff in the ISI_R2Y_SET2 register */
...
#define ISI_CR_ISI_EN(value)                  (ISI_CR_ISI_EN_Msk & (_UINT32_(value) << ISI_CR_ISI_EN_Pos)) /* Assigment of value for ISI_EN in the ISI_CR register */
...
#define ISI_CR_ISI_DIS(value)                 (ISI_CR_ISI_DIS_Msk & (_UINT32_(value) << ISI_CR_ISI_DIS_Pos)) /* Assigment of value for ISI_DIS in the ISI_CR register */
...
#define ISI_CR_ISI_SRST(value)                (ISI_CR_ISI_SRST_Msk & (_UINT32_(value) << ISI_CR_ISI_SRST_Pos)) /* Assigment of value for ISI_SRST in the ISI_CR register */
...
#define ISI_CR_ISI_CDC(value)                 (ISI_CR_ISI_CDC_Msk & (_UINT32_(value) << ISI_CR_ISI_CDC_Pos)) /* Assigment of value for ISI_CDC in the ISI_CR register */
...
#define ISI_SR_ENABLE(value)                  (ISI_SR_ENABLE_Msk & (_UINT32_(value) << ISI_SR_ENABLE_Pos)) /* Assigment of value for ENABLE in the ISI_SR register */
...
#define ISI_SR_DIS_DONE(value)                (ISI_SR_DIS_DONE_Msk & (_UINT32_(value) << ISI_SR_DIS_DONE_Pos)) /* Assigment of value for DIS_DONE in the ISI_SR register */
...
#define ISI_SR_SRST(value)                    (ISI_SR_SRST_Msk & (_UINT32_(value) << ISI_SR_SRST_Pos)) /* Assigment of value for SRST in the ISI_SR register */
...
#define ISI_SR_CDC_PND(value)                 (ISI_SR_CDC_PND_Msk & (_UINT32_(value) << ISI_SR_CDC_PND_Pos)) /* Assigment of value for CDC_PND in the ISI_SR register */
...
#define ISI_SR_VSYNC(value)                   (ISI_SR_VSYNC_Msk & (_UINT32_(value) << ISI_SR_VSYNC_Pos)) /* Assigment of value for VSYNC in the ISI_SR register */
...
#define ISI_SR_PXFR_DONE(value)               (ISI_SR_PXFR_DONE_Msk & (_UINT32_(value) << ISI_SR_PXFR_DONE_Pos)) /* Assigment of value for PXFR_DONE in the ISI_SR register */
...
#define ISI_SR_CXFR_DONE(value)               (ISI_SR_CXFR_DONE_Msk & (_UINT32_(value) << ISI_SR_CXFR_DONE_Pos)) /* Assigment of value for CXFR_DONE in the ISI_SR register */
...
#define ISI_SR_SIP(value)                     (ISI_SR_SIP_Msk & (_UINT32_(value) << ISI_SR_SIP_Pos)) /* Assigment of value for SIP in the ISI_SR register */
...
#define ISI_SR_P_OVR(value)                   (ISI_SR_P_OVR_Msk & (_UINT32_(value) << ISI_SR_P_OVR_Pos)) /* Assigment of value for P_OVR in the ISI_SR register */
...
#define ISI_SR_C_OVR(value)                   (ISI_SR_C_OVR_Msk & (_UINT32_(value) << ISI_SR_C_OVR_Pos)) /* Assigment of value for C_OVR in the ISI_SR register */
...
#define ISI_SR_CRC_ERR(value)                 (ISI_SR_CRC_ERR_Msk & (_UINT32_(value) << ISI_SR_CRC_ERR_Pos)) /* Assigment of value for CRC_ERR in the ISI_SR register */
...
#define ISI_SR_FR_OVR(value)                  (ISI_SR_FR_OVR_Msk & (_UINT32_(value) << ISI_SR_FR_OVR_Pos)) /* Assigment of value for FR_OVR in the ISI_SR register */
...
#define ISI_IER_DIS_DONE(value)               (ISI_IER_DIS_DONE_Msk & (_UINT32_(value) << ISI_IER_DIS_DONE_Pos)) /* Assigment of value for DIS_DONE in the ISI_IER register */
...
#define ISI_IER_SRST(value)                   (ISI_IER_SRST_Msk & (_UINT32_(value) << ISI_IER_SRST_Pos)) /* Assigment of value for SRST in the ISI_IER register */
...
#define ISI_IER_VSYNC(value)                  (ISI_IER_VSYNC_Msk & (_UINT32_(value) << ISI_IER_VSYNC_Pos)) /* Assigment of value for VSYNC in the ISI_IER register */
...
#define ISI_IER_PXFR_DONE(value)              (ISI_IER_PXFR_DONE_Msk & (_UINT32_(value) << ISI_IER_PXFR_DONE_Pos)) /* Assigment of value for PXFR_DONE in the ISI_IER register */
...
#define ISI_IER_CXFR_DONE(value)              (ISI_IER_CXFR_DONE_Msk & (_UINT32_(value) << ISI_IER_CXFR_DONE_Pos)) /* Assigment of value for CXFR_DONE in the ISI_IER register */
...
#define ISI_IER_P_OVR(value)                  (ISI_IER_P_OVR_Msk & (_UINT32_(value) << ISI_IER_P_OVR_Pos)) /* Assigment of value for P_OVR in the ISI_IER register */
...
#define ISI_IER_C_OVR(value)                  (ISI_IER_C_OVR_Msk & (_UINT32_(value) << ISI_IER_C_OVR_Pos)) /* Assigment of value for C_OVR in the ISI_IER register */
...
#define ISI_IER_CRC_ERR(value)                (ISI_IER_CRC_ERR_Msk & (_UINT32_(value) << ISI_IER_CRC_ERR_Pos)) /* Assigment of value for CRC_ERR in the ISI_IER register */
...
#define ISI_IER_FR_OVR(value)                 (ISI_IER_FR_OVR_Msk & (_UINT32_(value) << ISI_IER_FR_OVR_Pos)) /* Assigment of value for FR_OVR in the ISI_IER register */
...
#define ISI_IDR_DIS_DONE(value)               (ISI_IDR_DIS_DONE_Msk & (_UINT32_(value) << ISI_IDR_DIS_DONE_Pos)) /* Assigment of value for DIS_DONE in the ISI_IDR register */
...
#define ISI_IDR_SRST(value)                   (ISI_IDR_SRST_Msk & (_UINT32_(value) << ISI_IDR_SRST_Pos)) /* Assigment of value for SRST in the ISI_IDR register */
...
#define ISI_IDR_VSYNC(value)                  (ISI_IDR_VSYNC_Msk & (_UINT32_(value) << ISI_IDR_VSYNC_Pos)) /* Assigment of value for VSYNC in the ISI_IDR register */
...
#define ISI_IDR_PXFR_DONE(value)              (ISI_IDR_PXFR_DONE_Msk & (_UINT32_(value) << ISI_IDR_PXFR_DONE_Pos)) /* Assigment of value for PXFR_DONE in the ISI_IDR register */
...
#define ISI_IDR_CXFR_DONE(value)              (ISI_IDR_CXFR_DONE_Msk & (_UINT32_(value) << ISI_IDR_CXFR_DONE_Pos)) /* Assigment of value for CXFR_DONE in the ISI_IDR register */
...
#define ISI_IDR_P_OVR(value)                  (ISI_IDR_P_OVR_Msk & (_UINT32_(value) << ISI_IDR_P_OVR_Pos)) /* Assigment of value for P_OVR in the ISI_IDR register */
...
#define ISI_IDR_C_OVR(value)                  (ISI_IDR_C_OVR_Msk & (_UINT32_(value) << ISI_IDR_C_OVR_Pos)) /* Assigment of value for C_OVR in the ISI_IDR register */
...
#define ISI_IDR_CRC_ERR(value)                (ISI_IDR_CRC_ERR_Msk & (_UINT32_(value) << ISI_IDR_CRC_ERR_Pos)) /* Assigment of value for CRC_ERR in the ISI_IDR register */
...
#define ISI_IDR_FR_OVR(value)                 (ISI_IDR_FR_OVR_Msk & (_UINT32_(value) << ISI_IDR_FR_OVR_Pos)) /* Assigment of value for FR_OVR in the ISI_IDR register */
...
#define ISI_IMR_DIS_DONE(value)               (ISI_IMR_DIS_DONE_Msk & (_UINT32_(value) << ISI_IMR_DIS_DONE_Pos)) /* Assigment of value for DIS_DONE in the ISI_IMR register */
...
#define ISI_IMR_SRST(value)                   (ISI_IMR_SRST_Msk & (_UINT32_(value) << ISI_IMR_SRST_Pos)) /* Assigment of value for SRST in the ISI_IMR register */
...
#define ISI_IMR_VSYNC(value)                  (ISI_IMR_VSYNC_Msk & (_UINT32_(value) << ISI_IMR_VSYNC_Pos)) /* Assigment of value for VSYNC in the ISI_IMR register */
...
#define ISI_IMR_PXFR_DONE(value)              (ISI_IMR_PXFR_DONE_Msk & (_UINT32_(value) << ISI_IMR_PXFR_DONE_Pos)) /* Assigment of value for PXFR_DONE in the ISI_IMR register */
...
#define ISI_IMR_CXFR_DONE(value)              (ISI_IMR_CXFR_DONE_Msk & (_UINT32_(value) << ISI_IMR_CXFR_DONE_Pos)) /* Assigment of value for CXFR_DONE in the ISI_IMR register */
...
#define ISI_IMR_P_OVR(value)                  (ISI_IMR_P_OVR_Msk & (_UINT32_(value) << ISI_IMR_P_OVR_Pos)) /* Assigment of value for P_OVR in the ISI_IMR register */
...
#define ISI_IMR_C_OVR(value)                  (ISI_IMR_C_OVR_Msk & (_UINT32_(value) << ISI_IMR_C_OVR_Pos)) /* Assigment of value for C_OVR in the ISI_IMR register */
...
#define ISI_IMR_CRC_ERR(value)                (ISI_IMR_CRC_ERR_Msk & (_UINT32_(value) << ISI_IMR_CRC_ERR_Pos)) /* Assigment of value for CRC_ERR in the ISI_IMR register */
...
#define ISI_IMR_FR_OVR(value)                 (ISI_IMR_FR_OVR_Msk & (_UINT32_(value) << ISI_IMR_FR_OVR_Pos)) /* Assigment of value for FR_OVR in the ISI_IMR register */
...
#define ISI_DMA_CHER_P_CH_EN(value)           (ISI_DMA_CHER_P_CH_EN_Msk & (_UINT32_(value) << ISI_DMA_CHER_P_CH_EN_Pos)) /* Assigment of value for P_CH_EN in the ISI_DMA_CHER register */
...
#define ISI_DMA_CHER_C_CH_EN(value)           (ISI_DMA_CHER_C_CH_EN_Msk & (_UINT32_(value) << ISI_DMA_CHER_C_CH_EN_Pos)) /* Assigment of value for C_CH_EN in the ISI_DMA_CHER register */
...
#define ISI_DMA_CHDR_P_CH_DIS(value)          (ISI_DMA_CHDR_P_CH_DIS_Msk & (_UINT32_(value) << ISI_DMA_CHDR_P_CH_DIS_Pos)) /* Assigment of value for P_CH_DIS in the ISI_DMA_CHDR register */
...
#define ISI_DMA_CHDR_C_CH_DIS(value)          (ISI_DMA_CHDR_C_CH_DIS_Msk & (_UINT32_(value) << ISI_DMA_CHDR_C_CH_DIS_Pos)) /* Assigment of value for C_CH_DIS in the ISI_DMA_CHDR register */
...
#define ISI_DMA_CHSR_P_CH_S(value)            (ISI_DMA_CHSR_P_CH_S_Msk & (_UINT32_(value) << ISI_DMA_CHSR_P_CH_S_Pos)) /* Assigment of value for P_CH_S in the ISI_DMA_CHSR register */
...
#define ISI_DMA_CHSR_C_CH_S(value)            (ISI_DMA_CHSR_C_CH_S_Msk & (_UINT32_(value) << ISI_DMA_CHSR_C_CH_S_Pos)) /* Assigment of value for C_CH_S in the ISI_DMA_CHSR register */
...
#define ISI_DMA_P_ADDR_P_ADDR(value)          (ISI_DMA_P_ADDR_P_ADDR_Msk & (_UINT32_(value) << ISI_DMA_P_ADDR_P_ADDR_Pos)) /* Assigment of value for P_ADDR in the ISI_DMA_P_ADDR register */
...
#define ISI_DMA_P_CTRL_P_FETCH(value)         (ISI_DMA_P_CTRL_P_FETCH_Msk & (_UINT32_(value) << ISI_DMA_P_CTRL_P_FETCH_Pos)) /* Assigment of value for P_FETCH in the ISI_DMA_P_CTRL register */
...
#define ISI_DMA_P_CTRL_P_WB(value)            (ISI_DMA_P_CTRL_P_WB_Msk & (_UINT32_(value) << ISI_DMA_P_CTRL_P_WB_Pos)) /* Assigment of value for P_WB in the ISI_DMA_P_CTRL register */
...
#define ISI_DMA_P_CTRL_P_IEN(value)           (ISI_DMA_P_CTRL_P_IEN_Msk & (_UINT32_(value) << ISI_DMA_P_CTRL_P_IEN_Pos)) /* Assigment of value for P_IEN in the ISI_DMA_P_CTRL register */
...
#define ISI_DMA_P_CTRL_P_DONE(value)          (ISI_DMA_P_CTRL_P_DONE_Msk & (_UINT32_(value) << ISI_DMA_P_CTRL_P_DONE_Pos)) /* Assigment of value for P_DONE in the ISI_DMA_P_CTRL register */
...
#define ISI_DMA_P_DSCR_P_DSCR(value)          (ISI_DMA_P_DSCR_P_DSCR_Msk & (_UINT32_(value) << ISI_DMA_P_DSCR_P_DSCR_Pos)) /* Assigment of value for P_DSCR in the ISI_DMA_P_DSCR register */
...
#define ISI_DMA_C_ADDR_C_ADDR(value)          (ISI_DMA_C_ADDR_C_ADDR_Msk & (_UINT32_(value) << ISI_DMA_C_ADDR_C_ADDR_Pos)) /* Assigment of value for C_ADDR in the ISI_DMA_C_ADDR register */
...
#define ISI_DMA_C_CTRL_C_FETCH(value)         (ISI_DMA_C_CTRL_C_FETCH_Msk & (_UINT32_(value) << ISI_DMA_C_CTRL_C_FETCH_Pos)) /* Assigment of value for C_FETCH in the ISI_DMA_C_CTRL register */
...
#define ISI_DMA_C_CTRL_C_WB(value)            (ISI_DMA_C_CTRL_C_WB_Msk & (_UINT32_(value) << ISI_DMA_C_CTRL_C_WB_Pos)) /* Assigment of value for C_WB in the ISI_DMA_C_CTRL register */
...
#define ISI_DMA_C_CTRL_C_IEN(value)           (ISI_DMA_C_CTRL_C_IEN_Msk & (_UINT32_(value) << ISI_DMA_C_CTRL_C_IEN_Pos)) /* Assigment of value for C_IEN in the ISI_DMA_C_CTRL register */
...
#define ISI_DMA_C_CTRL_C_DONE(value)          (ISI_DMA_C_CTRL_C_DONE_Msk & (_UINT32_(value) << ISI_DMA_C_CTRL_C_DONE_Pos)) /* Assigment of value for C_DONE in the ISI_DMA_C_CTRL register */
...
#define ISI_DMA_C_DSCR_C_DSCR(value)          (ISI_DMA_C_DSCR_C_DSCR_Msk & (_UINT32_(value) << ISI_DMA_C_DSCR_C_DSCR_Pos)) /* Assigment of value for C_DSCR in the ISI_DMA_C_DSCR register */
...
#define ISI_WPMR_WPEN(value)                  (ISI_WPMR_WPEN_Msk & (_UINT32_(value) << ISI_WPMR_WPEN_Pos)) /* Assigment of value for WPEN in the ISI_WPMR register */
...
#define ISI_WPMR_WPKEY(value)                 (ISI_WPMR_WPKEY_Msk & (_UINT32_(value) << ISI_WPMR_WPKEY_Pos)) /* Assigment of value for WPKEY in the ISI_WPMR register */
...
#define ISI_WPSR_WPVS(value)                  (ISI_WPSR_WPVS_Msk & (_UINT32_(value) << ISI_WPSR_WPVS_Pos)) /* Assigment of value for WPVS in the ISI_WPSR register */
...
#define ISI_WPSR_WPVSRC(value)                (ISI_WPSR_WPVSRC_Msk & (_UINT32_(value) << ISI_WPSR_WPVSRC_Pos)) /* Assigment of value for WPVSRC in the ISI_WPSR register */
